...
export default function PropertyHunterPage() {
  ...
  useEffect(() => {
    ...
    if (isMenuOpen) {
      console.log('[PropertyHunterPage] Menu is open, skipping ScrollTrigger creation');
      return;
    }
    
    console.log('[PropertyHunterPage] Creating ScrollTrigger for jersey text');
    gsap.registerPlugin(ScrollTrigger);

    const textElement = jerseyTextRef.current;
    if (!textElement) {
      console.log('[PropertyHunterPage] Text element not found');
      return;
    }
    ...
    if (lines.length > 0) {
      ...
      if (innerLines.length > 0) {
        ...
        scrollTriggerRef.current = ScrollTrigger.create({
          ...
          start: "top 80%",
          onEnter: () => {
            console.log('[PropertyHunterPage] ScrollTrigger onEnter triggered, isMenuOpen:', isMenuOpen);
            if (isMenuOpen) {
              console.log('[PropertyHunterPage] Menu is open, skipping animation');
              return;
            }
            console.log('[PropertyHunterPage] Animating text');
            gsap.to(
              Array.from(innerLines) as HTMLElement[],
              {
                y: "0%",
        ...
        console.log('[PropertyHunterPage] ScrollTrigger created successfully');
      }
    }

    return () => {
      console.log('[PropertyHunterPage] Cleaning up ScrollTrigger');
      ...
      <main className="min-h-screen bg-[#090909] relative flex flex-col">
        ...
        <section className="section section__1 darkGradient first relative z-0 text-colorLight" style={{ isolation: 'isolate' }}>
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <Image
              src="/img/Project/Property hunter/Photo header Property Hunter.png"
              alt="Property Hunter Header"
              fill
          ...
          <div className="absolute inset-0 flex flex-col items-start justify-center z-10 pointer-events-none" style={{ pointerEvents: 'none' }}>
            <div className="flex-1 flex flex-col items-start justify-center text-left pl-[15%] md:pl-[20%] lg:pl-[25%] max-w-7xl relative z-10">
              {/* Logo Property Hunter au-dessus du paragraphe */}
              <div ref={logoRef} className="mb-0">
                <Image
                  src="/img/Project/Property hunter/Property Hunter logo.webp"
                  alt="Property Hunter Logo"
                  width={120}
                  height={120}
          ...
          <div className="container mx-auto px-6vw py-20 max-w-[1690px]">
            <div className="grid grid-cols-1 lg:grid-cols-[40%_60%] gap-12 lg:gap-16 items-start">
              ...
              <div className="space-y-8 h-full">
                ...
                {/* Date */}
                <p className="text-white text-sm">Sep 15, 2025</p>
                ...
                <div className="space-y-4 text-white">
                  <p className="text-base leading-relaxed">
                    For Property Hunter, NRV Agency runs their social presence end-to-end: content production (photo/video + short-form), publishing and community follow-up, and performance-driven paid campaigns. We translate their expertise into clear, trust-building content and ad creatives designed to increase visibility and generate qualified leads.
                  </p>
                </div>
              ...
              <div className="w-full h-full">
                <Image
                  src="/img/Project/Property hunter/Photo projet Property Hunter.png"
                  alt="Property Hunter project"
                  width={1200}
                  height={1600}
                  quality={100}
                  className="w-full h-full object-cover"
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <div className="w-full">
                  <Image
                    src="/img/Project/Property hunter/Property Hunter photo projet 1.webp"
                    alt="Property Hunter photo projet 1"
                    width={1200}
                    height={1600}
                    quality={100}
                ...
                <div className="w-full">
                  <Image
                    src="/img/Project/Property hunter/Property Hunter photo projet 2.webp"
                    alt="Property Hunter photo projet 2"
                    width={1200}
                    height={1600}
                    quality={100}
                    className="w-full h-auto object-cover"
                ...
                <div className="w-full">
                  <Image
                    src="/img/Project/Property hunter/Property Hunter photo projet 3.webp"
                    alt="Property Hunter photo projet 3"
                    width={1200}
                    height={1600}
                    quality={100}
                    className="w-full h-auto object-cover"
                ...
                <div className="w-full">
                  <Image
                    src="/img/Project/Property hunter/Property Hunter photo projet 4.webp"
                    alt="Property Hunter photo projet 4"
                    width={1200}
                    height={1600}
                    quality={100}
                    className="w-full h-auto object-cover"
                ...
                <div className="w-full">
                  <Image
                    src="/img/Project/Property hunter/Property Hunter photo projet 5.webp"
                    alt="Property Hunter photo projet 5"
                    width={1200}
                    height={1600}
                    quality={100}
                    className="w-full h-auto object-cover"
                ...
                <div className="w-full">
                  <Image
                    src="/img/Project/Property hunter/Property Hunter photo projet 6.webp"
                    alt="Property Hunter photo projet 6"
                    width={1200}
                    height={1600}
                    quality={100}
                    className="w-full h-auto object-cover"
                ...
                <div className="flex justify-start">
                  <div className="grid grid-cols-2 gap-2 max-w-xl">
                    <div className="w-full">
                      ...
                      >
                        <source
                          src="/img/Project/Property hunter/Reel property hunter 1.mp4"
                          type="video/mp4"
                        />
                      </video>
                    </div>
                    <div className="w-full">
                      ...
                      >
                        <source
                          src="/img/Project/Property hunter/Reel property hunter 2.mp4"
                          type="video/mp4"
                        />
                      </video>
                    </div>
