...
export default function SinclairPilatesPage() {
      ...
      <main className="min-h-screen bg-[#090909] relative flex flex-col">
        ...
        <section className="section section__1 darkGradient first relative z-0 text-colorLight" style={{ isolation: 'isolate' }}>
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            >
              <source
                src="/img/Project/Sinclair Pilates/Studio Sinclair Pilates vidéo.mp4"
                type="video/mp4"
              />
            </video>
          ...
          <div className="absolute inset-0 flex flex-col items-start justify-center z-10 pointer-events-none" style={{ pointerEvents: 'none' }}>
            <div className="flex-1 flex flex-col items-start justify-center text-left pl-[15%] md:pl-[20%] lg:pl-[25%] max-w-7xl relative z-10">
              {/* Logo Sinclair Pilates au-dessus du paragraphe */}
              <div ref={logoRef} className="mb-8">
                <Image
                  src="/img/Project/Sinclair Pilates/Logo Sinclair Pilates.webp"
                  alt="Sinclair Pilates Logo"
                  width={80}
                  height={80}
          ...
          <div className="container mx-auto px-6vw py-20 max-w-[1690px]">
            <div className="grid grid-cols-1 lg:grid-cols-[40%_60%] gap-12 lg:gap-16 items-start">
              ...
              <div className="space-y-8 h-full">
                ...
                {/* Date */}
                <p className="text-white text-sm">Apr 3, 2025</p>
                ...
                <div className="space-y-4 text-white">
                  <p className="text-base leading-relaxed">
                    As the agency behind Sinclair Pilates&apos; premium Reformer studio, we crafted a refined brand direction color palette, typography, and overall visual identity then translated it into a conversion-focused website experience. We designed the site structure to guide visitors effortlessly from discovery to action, with clear service messaging, streamlined inquiry flows, and a mobile-first layout built for performance. Beyond the build, we implemented tracking and analytics to measure results, and supported the launch with paid advertising and marketing setup to attract qualified local prospects. The outcome: a polished, high-performing website and marketing foundation designed to help the client consistently turn visitors into new bookings.
                  </p>
                </div>
              ...
              <div className="w-full h-full">
                <Image
                  src="/img/Project/Sinclair Pilates/Sinclair Pilates photo 1.webp"
                  alt="Sinclair Pilates"
                  width={1200}
                  height={1600}
                  quality={100}
                  className="w-full h-full object-cover"
        ...
        <section className="relative w-full bg-[#090909]">
          <div className="container mx-auto px-6vw pb-20 max-w-[1690px]">
            <div className="grid grid-cols-3 gap-2">
              {/* Photo large au-dessus des 3 photos */}
              <div className="col-span-3 w-full">
                <Image
                  src="/img/Project/Sinclair Pilates/Sinclair Pilates photo 2.webp"
                  alt="Sinclair Pilates"
                  width={1920}
                  height={1080}
                  quality={100}
              ...
              <div className="col-span-3 grid grid-cols-2 gap-2">
                <div className="w-full">
                  ...
                  >
                    <source
                      src="/img/Project/Sinclair Pilates/GIF WEBSITE 2.mp4"
                      type="video/mp4"
                    />
                  </video>
                </div>
                <div className="w-full">
                  ...
                  >
                    <source
                      src="/img/Project/Sinclair Pilates/GIF WEBSITE 3.mp4"
                      type="video/mp4"
                    />
                  </video>
                </div>
              </div>
              {/* Vidéo large en dessous des 2 vidéos */}
              <div className="col-span-3 w-full">
                <video
                  autoPlay
                  loop
                ...
                >
                  <source
                    src="/img/Project/Sinclair Pilates/GIF WEBSITE 4.mp4"
                    type="video/mp4"
                  />
                </video>
              </div>
              {/* Photo en dessous de la vidéo */}
              <div className="col-span-3 w-full">
                <Image
                  src="/img/Project/Sinclair Pilates/Sinclair Pilates photo 3.webp"
                  alt="Sinclair Pilates"
                  width={1920}
                  height={1080}
                  quality={100}
              ...
              {/* Deux photos en dessous de la photo 3 */}
              <div className="col-span-3 grid grid-cols-2 gap-2">
                <div className="w-full">
                  <Image
                    src="/img/Project/Sinclair Pilates/Sinclair Pilates photo 9.webp"
                    alt="Sinclair Pilates"
                    width={1200}
                    height={1600}
                    quality={100}
                ...
                <div className="w-full">
                  <Image
                    src="/img/Project/Sinclair Pilates/Sinclair Pilates photo 10.webp"
                    alt="Sinclair Pilates"
                    width={1200}
                    height={1600}
                    quality={100}
              ...
              {/* Trois vidéos juste avant les 3 photos */}
              <div className="col-span-3 grid grid-cols-3 gap-2">
                <div className="w-full">
                  ...
                  >
                    <source
                      src="/img/Project/Sinclair Pilates/Reel Sinclair Pilates.mp4"
                      type="video/mp4"
                    />
                  </video>
                </div>
                <div className="w-full">
                  ...
                  >
                    <source
                      src="/img/Project/Sinclair Pilates/Reel Sinclair Pilates 2.mp4"
                      type="video/mp4"
                    />
                  </video>
                </div>
                <div className="w-full">
                  ...
                  >
                    <source
                      src="/img/Project/Sinclair Pilates/Reel Sinclair Pilates 3.mp4"
                      type="video/mp4"
                    />
                  </video>
                </div>
              </div>
              {/* Trois photos en dessous des 2 vidéos */}
              <div className="w-full">
                <Image
                  src="/img/Project/Sinclair Pilates/Sinclair Pilates photo 4.webp"
                  alt="Sinclair Pilates"
                  width={1200}
                  height={1600}
                  quality={100}
              ...
              <div className="w-full">
                <Image
                  src="/img/Project/Sinclair Pilates/Sinclair Pilates photo 5.webp"
                  alt="Sinclair Pilates"
                  width={1200}
                  height={1600}
                  quality={100}
              ...
              <div className="w-full">
                <Image
                  src="/img/Project/Sinclair Pilates/Sinclair Pilates photo 6.webp"
                  alt="Sinclair Pilates"
                  width={1200}
                  height={1600}
                  quality={100}
              ...
              {/* Deux photos en dessous des 3 photos */}
              <div className="col-span-3 grid grid-cols-2 gap-2">
                <div className="w-full">
                  <Image
                    src="/img/Project/Sinclair Pilates/Sinclair Pilates photo 7.webp"
                    alt="Sinclair Pilates"
                    width={1200}
                    height={1600}
                    quality={100}
                ...
                <div className="w-full">
                  <Image
                    src="/img/Project/Sinclair Pilates/Sinclair Pilates photo 8.webp"
                    alt="Sinclair Pilates"
                    width={1200}
                    height={1600}
                    quality={100}
