...
export function AboutWrapper({}) {
  const [text, setText] = useState({
    main: "Featured Work",
    para: `We craft comprehensive digital solutions: content creation, web development, and strategic consulting. Our team designs user-centric experiences with data-driven campaigns to ensure your brand resonates online.`,
  });
  useEffect(() => {
    if (!isDesktop()) {
      setText({
